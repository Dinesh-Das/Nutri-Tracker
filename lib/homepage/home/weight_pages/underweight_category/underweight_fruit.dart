...
class underweightfruits extends StatefulWidget {
  const underweightfruits({Key? key}) : super(key: key);

  @override
  _underweightfruitsState createState() => _underweightfruitsState();
}

// int current = Random().nextInt(WLFruitsList.length);

class _underweightfruitsState extends State<underweightfruits> {
